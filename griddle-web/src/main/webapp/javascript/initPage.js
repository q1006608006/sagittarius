...
(function(window,undefined){
	...
	function initPage(id,option){
		...
		if(isJump){
			...
			input.style.outlineColor='#f5921d';
	...
	function changeColor(node){
		node.style.backgroundColor='#F5921D';
	}
	...
	function createPageList(curPage,totalPage,showCount){
		...
		for(i=0;i<lis.length;i++){
			...
			if(tempLi.className == 'active'){
				tempLi.childNodes[0].style.backgroundColor = '#F5921D';
