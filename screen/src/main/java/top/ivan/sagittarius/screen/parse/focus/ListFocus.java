...
public class ListFocus implements Focus, ExportFocusHandle {
    private static final long serialVersionUID = -6048315385200686542L;
     ...
     * @parseNull $:""->null, #:null->"", +:null->"null", -:null->skip(if target accept with '@'(ex:@+),then "" will be translate to null)
     */
    @Override
